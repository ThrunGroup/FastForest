...
model1 = RandomForestRegressor(n_estimators=15, max_leaf_nodes=6, max_features="sqrt")
model2 = ForestRegressor(n_estimators=30, max_leaf_nodes=6, feature_subsampling="SQRT")
model3 = ForestRegressor(n_estimators=30, max_leaf_nodes=6, feature_subsampling="SQRT", solver="EXACT")
