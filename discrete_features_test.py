...
if __name__ == "__main__":
    ...
    t = TreeClassifier(data=data, labels=labels, classes={0: 0}, max_depth=1, make_discrete=True, bin_type="")
    start_time = time.time()
    t.fit(data, labels)
    print(f"Time taken for fitting and creating discrete features: {time.time() - start_time}")
