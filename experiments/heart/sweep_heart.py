import wandb
from experiments.heart.fit_heart import fit
from utils.constants import SKLEARN, HEART
...
if __name__ == "__main__":
    ...
    parameters_dict = {
        ...
        "seed": {"distribution": "constant", "value": 1},
        "verbose": {"distribution": "constant", "value": True},
        "sub_size": {"distribution": "constant", "value": 3000},
        "bootstrap": {"distribution": "constant", "value": True},
        "is_balanced": {"distribution": "constant", "value": True},
    }
